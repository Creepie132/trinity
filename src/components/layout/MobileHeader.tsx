    ...
    <>
      ...
      <header className="lg:hidden sticky top-0 z-40 w-full bg-white/90 dark:bg-slate-800/90 backdrop-blur-lg border-b border-gray-200 dark:border-slate-700 shadow-sm">
        {/*
          ...
          игнорируя язык страницы. Это НАМЕРЕННО — позиции иконок
          зафиксированы глобально:
        ...
        */}
        <div dir="ltr" className="flex items-center justify-between w-full px-4 h-16">
          ...
          {/* dir возвращается к языку страницы, чтобы внутренние
              dropdown-ы и текст правильно отображались в RTL. */}
          {hasBranches ? (
            <div ref={branchRef} dir={language === 'he' ? 'rtl' : 'ltr'} className="relative">
              <button
          ...
          {/* ── Right (всегда): Уведомления + Бургер ── */}
