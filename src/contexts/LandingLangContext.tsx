...
const translations: Record<LandingLang, Record<string, string>> = {
  ru: {
    ...
    'pricing.base.1': 'Клиенты',
    'pricing.base.2': 'Визиты / Записи',
    'pricing.base.3': 'Дневник и задачи',
    'pricing.base.4': 'Склад',
    'pricing.pro.1': 'Всё из Base',
    'pricing.pro.2': 'Онлайн-запись',
    'pricing.pro.3': 'Статистика и отчёты',
    'pricing.pro.4': 'SMS и напоминания',
    'pricing.enterprise.1': 'Всё из Base и Pro',
    'pricing.enterprise.2': 'Филиалы',
    'pricing.enterprise.3': 'Программа лояльности',
    'pricing.enterprise.4': 'До 5 работников',
    'pricing.custom.title': 'Индивидуальная',
    'pricing.custom.price': 'По выбору',
    'pricing.custom.1': 'Выберите нужные модули',
    'pricing.custom.2': 'Инд. конфигурация',
    'pricing.custom.3': 'Приоритетная поддержка',
    'pricing.custom.4': 'Скидка до 15% от 5+ модулей',
    'features.wa.chat1': 'Здравствуйте, Анна! Напоминаем о записи завтра в 14:00 💋',
    'features.wa.chat2': 'Спасибо! Буду вовремя 👍',
    'features.wa.chat3': 'Отлично! Ждём вас в салоне ✨',
  ...
  en: {
    ...
    'pricing.base.1': 'Clients',
    'pricing.base.2': 'Visits / Bookings',
    'pricing.base.3': 'Diary & tasks',
    'pricing.base.4': 'Inventory',
    'pricing.pro.1': 'Everything in Base',
    'pricing.pro.2': 'Online booking',
    'pricing.pro.3': 'Statistics & reports',
    'pricing.pro.4': 'SMS & reminders',
    'pricing.enterprise.1': 'Everything in Base & Pro',
    'pricing.enterprise.2': 'Branches',
    'pricing.enterprise.3': 'Loyalty program',
    'pricing.enterprise.4': 'Up to 5 staff members',
    'pricing.custom.title': 'Custom',
    'pricing.custom.price': 'Your choice',
    'pricing.custom.1': 'Choose the modules you need',
    'pricing.custom.2': 'Custom configuration',
    'pricing.custom.3': 'Priority support',
    'pricing.custom.4': 'Up to 15% off with 5+ modules',
    'features.wa.chat1': 'Hello, Anna! Reminder: your appointment is tomorrow at 2:00 PM 💋',
    'features.wa.chat2': 'Thank you! I\'ll be there on time 👍',
    'features.wa.chat3': 'Great! We look forward to seeing you ✨',
  ...
  he: {
    ...
    'pricing.base.1': 'לקוחות',
    'pricing.base.2': 'ביקורים / תורים',
    'pricing.base.3': 'יומן ומשימות',
    'pricing.base.4': 'מלאי',
    'pricing.pro.1': 'הכל מ-Base',
    'pricing.pro.2': 'הזמנה אונליין',
    'pricing.pro.3': 'סטטיסטיקה ודוחות',
    'pricing.pro.4': 'SMS ותזכורות',
    'pricing.enterprise.1': 'הכל מ-Base ו-Pro',
    'pricing.enterprise.2': 'סניפים',
    'pricing.enterprise.3': 'תוכנית נאמנות',
    'pricing.enterprise.4': 'עד 5 עובדים',
    'pricing.custom.title': 'אישית',
    'pricing.custom.price': 'לפי בחירה',
    'pricing.custom.1': 'בחר את המודולים הדרושים',
    'pricing.custom.2': 'הגדרה אישית',
    'pricing.custom.3': 'תמיכה מועדפת',
    'pricing.custom.4': 'הנחה עד 15% מ-5+ מודולים',
    'features.wa.chat1': 'שלום, אנה! תזכורת: התור שלך מחר בשעה 14:00 💋',
    'features.wa.chat2': 'תודה! אהיה בזמן 👍',
    'features.wa.chat3': 'מצוין! מחכים לך ✨',
