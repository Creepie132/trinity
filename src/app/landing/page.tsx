    ...
    <div dir={t.dir} className="page-root">
      ...
      <nav id="nav" className={scrolled ? 'scrolled' : ''}>
        ...
        <div className="nav-right">
          ...
          <a href="/login" className="desktop-only inline-block bg-gradient-to-r from-amber-400 to-amber-500 text-white px-5 py-2 rounded-full shadow-lg shadow-amber-400/40 animate-pulse hover:from-amber-300 hover:to-amber-400 transition-all font-semibold">{t.navCta}</a>
      ...
      <div className={`mobile-menu${mobileOpen ? ' open' : ''}`}>
        ...
        <a href="/login"    onClick={() => setMobileOpen(false)} className="inline-block bg-gradient-to-r from-amber-400 to-amber-500 text-white px-5 py-2 rounded-full shadow-lg shadow-amber-400/40 hover:from-amber-300 hover:to-amber-400 transition-all font-semibold text-center">{t.navCta}</a>
