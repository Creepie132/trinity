...
import {
  ...
  Phone, User, Building2, Mail, Check, ArrowRight,
} from 'lucide-react'
...
const T = {
  he: {
    ...
    limit_note:   '10 לקוחות · 15 ביקורים (3 בו-זמנית) · 5 מוצרים · 5 משימות',
    back:         'שנה שפה',
    err_req:      'שדה חובה',
    err_phone:    'מספר לא תקין',
    err_email:    'אימייל לא תקין',
  ...
  ru: {
    ...
    limit_note:   '10 клиентов · 15 визитов (3 одновременно) · 5 товаров · 5 задач',
    back:         'Сменить язык',
