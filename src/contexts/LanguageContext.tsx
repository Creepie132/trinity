...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'admin.orgs.addNewShort': 'הוסף ארגון',
    ...
    'admin.orgs.stats': 'סטטיסטיקה',
    'admin.orgs.info': 'מידע',
    ...
    'settings.booking': 'הזמנת תורים',
    'settings.booking.desc': 'ניהול הגדרות הזמנת תורים אונליין',
    
    // Booking Settings
    'booking.title': 'הגדרות הזמנת תורים',
    'booking.subtitle': 'נהל הזמנות תורים אונליין מלקוחות',
    'booking.enabled': 'הפעל הזמנת תורים',
    'booking.enabled.desc': 'אפשר ללקוחות להזמין תורים דרך קישור ציבורי',
    'booking.slug': 'קישור הזמנה',
    'booking.slug.desc': 'כתובת URL ייחודית לדף ההזמנות שלך',
    'booking.slug.placeholder': 'my-business',
    'booking.slug.preview': 'הקישור שלך',
    'booking.slug.copy': 'העתק',
    'booking.slug.copied': 'הקישור הועתק!',
    'booking.workingHours': 'שעות פעילות',
    'booking.workingHours.desc': 'הגדר את שעות הפעילות שלך לפי ימים',
    'booking.day.sunday': 'ראשון',
    'booking.day.monday': 'שני',
    'booking.day.tuesday': 'שלישי',
    'booking.day.wednesday': 'רביעי',
    'booking.day.thursday': 'חמישי',
    'booking.day.friday': 'שישי',
    'booking.day.saturday': 'שבת',
    'booking.day.enabled': 'פעיל',
    'booking.hours.start': 'שעת התחלה',
    'booking.hours.end': 'שעת סיום',
    'booking.break': 'הפסקה',
    'booking.break.enabled': 'יש הפסקה',
    'booking.break.start': 'התחלת הפסקה',
    'booking.break.end': 'סיום הפסקה',
    'booking.slotDuration': 'משך סלוט (דקות)',
    'booking.slotDuration.desc': 'כמה זמן לכל תור',
    'booking.minAdvanceHours': 'שעות מראש מינימום',
    'booking.minAdvanceHours.desc': 'כמה שעות מראש חייבים להזמין',
    'booking.maxDaysAhead': 'מקסימום ימים קדימה',
    'booking.maxDaysAhead.desc': 'כמה רחוק אפשר להזמין תור',
    'booking.confirmMessage': 'הודעת אישור',
    'booking.confirmMessage.desc': 'הודעה שתוצג ללקוח אחרי ההזמנה (עברית)',
    'booking.confirmMessage.placeholder': 'תודה על ההזמנה! נחזור אליך בהקדם.',
    'booking.confirmMessageRu': 'הודעת אישור (רוסית)',
    'booking.confirmMessageRu.desc': 'הודעה שתוצג ללקוח אחרי ההזמנה (רוסית)',
    'booking.confirmMessageRu.placeholder': 'Спасибо за запись! Мы свяжемся с вами.',
    'booking.save': 'שמור הגדרות',
    'booking.saving': 'שומר...',
    'booking.saved': 'ההגדרות נשמרו!',
    
    // Online Bookings (Visits Page Tab)
    'bookings.title': 'הזמנות אונליין',
    'bookings.pending': 'ממתינות',
    'bookings.confirmed': 'מאושרות',
    'bookings.cancelled': 'מבוטלות',
    'bookings.name': 'שם',
    'bookings.phone': 'טלפון',
    'bookings.service': 'שירות',
    'bookings.date': 'תאריך',
    'bookings.time': 'שעה',
    'bookings.status': 'סטטוס',
    'bookings.actions': 'פעולות',
    'bookings.confirm': 'אשר',
    'bookings.cancel': 'בטל',
    'bookings.confirming': 'מאשר...',
    'bookings.cancelling': 'מבטל...',
    'bookings.confirmSuccess': 'ההזמנה אושרה וביקור נוצר!',
    'bookings.cancelSuccess': 'ההזמנה בוטלה',
    'bookings.noBookings': 'אין הזמנות',
    'bookings.noPending': 'אין הזמנות ממתינות',
    ...
    'dashboard.visitsMonth': 'תורים החודש',
    ...
    'dashboard.todayBookings': 'תורים להיום',
    'dashboard.lowStock': 'מלאי נמוך',
    'dashboard.pendingBookings': 'הזמנות ממתינות',
    'dashboard.avgVisit': 'ממוצע לביקור',
    'dashboard.customize': 'התאמת לוח בקרה',
    'dashboard.customize.desc': 'בחר אילו ווידג\'טים להציג בלוח הבקרה',
    'dashboard.customize.title': 'התאמת לוח בקרה',
    'dashboard.customize.subtitle': 'בחר עד 4 ווידג\'טים למובייל, עד 8 לדסקטופ',
    'dashboard.customize.available': 'ווידג\'טים זמינים',
    'dashboard.customize.moveUp': 'הזז למעלה',
    'dashboard.customize.moveDown': 'הזז למטה',
    'dashboard.customize.maxMobile': 'מקסימום 4 ווידג\'טים במובייל',
    'dashboard.customize.maxDesktop': 'מקסימום 8 ווידג\'טים בדסקטופ',
    'dashboard.widgets.visits_month': 'תורים החודש',
    'dashboard.widgets.total_clients': 'סה״כ לקוחות',
    'dashboard.widgets.inactive_clients': 'לקוחות לא פעילים',
    'dashboard.widgets.revenue_month': 'הכנסות החודש',
    'dashboard.widgets.today_bookings': 'תורים להיום',
    ...
    'dashboard.visitsChartDesc': 'גרף תורים לפי חודשים (עמודות)',
    ...
    'clients.subtitle': 'ניהול לקוחות והיסטוריית תורים',
    ...
    'clients.history': 'היסטוריית תורים',
    ...
    'clients.createPaymentLink': 'צור קישור תשלום',
    'clients.sendSMS': 'שלח SMS',
    'clients.visitHistory': 'היסטוריית תורים',
    'clients.noVisitHistory': 'אין היסטוריית תורים',
    'clients.payments': 'תשלומים',
    'clients.noPayments': 'אין תשלומים',
    'clients.sms': 'SMS',
    'clients.noSMS': 'אין הודעות SMS',
    'clients.adminRole': 'מנהל מערכת',
    'clients.manager': 'מנהל',
    'clients.fullAccess': 'גישה מלאה',
    'clients.limitedAccess': 'גישה מוגבלת',
    'clients.removePermissions': 'הסר הרשאות',
    'clients.removing': 'מסיר...',
    'clients.assignAsAdmin': 'מנה כמנהל',
    'clients.paid': 'שולם',
    'clients.pending': 'ממתין',
    'clients.failed': 'נכשל',
    'clients.refunded': 'הוחזר',
    'clients.transactionId': 'מזהה עסקה',
    'clients.created': 'נוצר',
    'clients.allVisits': 'כל התורים',
    'clients.dateLabel': 'תאריך',
    'clients.completedAt': 'הושלם בתאריך',
    'clients.duration': 'משך',
    'clients.minutes': 'דקות',
    
    // Visits
    'visits.title': 'יומן',
    'visits.subtitle': 'ניהול תורים ושירותים',
    ...
    'visits.status.in_progress': 'בתהליך',
    'visits.status.completed': 'הושלם',
    'visits.status.cancelled': 'בוטל',
    'visits.scheduled': 'מתוכנן',
    'visits.completed': 'הושלם',
    'visits.viewDetails': 'צפה בפרטים',
    ...
    'visits.confirmPayment': 'אשר תשלום',
    ...
    'visits.inProgress': 'בתהליך',
    'visits.activeVisit': 'ביקור פעיל',
    'visits.addService': 'הוסף שירות',
    'visits.regularService': 'שירות קבוע',
    'visits.oneTimeService': 'שירות חד פעמי',
    'visits.customService': 'הזן שירות חדש',
    'visits.addCustomService': 'הוסף שירות חד פעמי',
    'visits.serviceName': 'שם השירות',
    'visits.enterServiceName': 'הזן שם שירות',
    'visits.price': 'מחיר',
    'visits.duration': 'משך זמן',
    'visits.fillAllFields': 'אנא מלא את כל השדות',
    ...
    'inventory.scanner.permissionDenied': 'אישור גישה למצלמה נדרש. אנא אשר גישה בהגדרות הדפדפן.',
    'inventory.scanner.noCameraFound': 'לא נמצאה מצלמה במכשיר זה.',
    'inventory.scanner.cameraInUse': 'המצלמה בשימוש על ידי אפליקציה אחרת.',
    'inventory.scanner.unsupportedConstraints': 'המצלמה אינה תומכת בהגדרות הנדרשות.',
    'inventory.scanner.notSupported': 'הדפדפן אינו תומך בגישה למצלמה. אנא השתמש בדפדפן מעודכן.',
    'inventory.scanner.placeBarcode': 'מקם את הברקוד במסגרת המצלמה',
    ...
    'careInstructions.create': 'הוסף הוראה',
    'careInstructions.writeManually': 'כתוב ידנית',
    'careInstructions.uploadPDF': 'העלה PDF',
    'careInstructions.selectPDFFile': 'בחר קובץ PDF',
    'careInstructions.pdfUploadNote': 'הקובץ יישמר ויישלח ללקוחות אוטומטית',
    ...
    'careInstructions.downloadAsTxt': 'הורד כקובץ טקסט',
    ...
    'stats.visitsByMonth': 'תורים לפי חודש',
    ...
    'broadcast.title': 'רשימת תפוצה WhatsApp',
    'broadcast.limitTitle': 'מגבלת שליחה יומית',
    'broadcast.limitOver': '🚫 הגעת למגבלה היומית',
    'broadcast.limitOverDesc': 'תוכל לשלוח הודעות חדשות מחר. WhatsApp מגביל שליחה המונית להגנה על חשבונך.',
    'broadcast.limitRemaining': 'נותרו {count} הודעות להיום',
    'broadcast.searchPlaceholder': 'חיפוש לקוח...',
    'broadcast.filterAll': 'הכל',
    'broadcast.filter30': '30+ ימים',
    'broadcast.filter60': '60+ ימים',
    'broadcast.filter90': '90+ ימים',
    'broadcast.selectedCount': 'נבחרו {count}',
    'broadcast.selectAll': 'בחר הכל',
    'broadcast.clearSelection': 'נקה',
    'broadcast.daysAgo': 'לפני {count} ימים',
    'broadcast.noClients': 'לא נמצאו לקוחות',
    'broadcast.messageTitle': 'הודעה לשליחה',
    'broadcast.messagePlaceholder': 'כתוב את ההודעה שלך כאן...',
    'broadcast.messageNote': '* ההודעה תישלח לכל הלקוחות שנבחרו',
    'broadcast.selectedSummary': '{count} לקוחות נבחרו לשליחה',
    'broadcast.resultTitle': 'הרשימה נשלחה!',
    'broadcast.resultSent': 'נשלחו: {count}',
    'broadcast.resultFailed': 'נכשלו: {count}',
    'broadcast.resultSkipped': 'דולגו (מגבלה): {count}',
    'broadcast.sendBtn': 'שלח ל-{count} לקוחות',
    'broadcast.sending': 'שולח...',
    'broadcast.limitNote': 'WhatsApp מגביל שליחה המונית ל-30 הודעות ב-24 שעות. המגבלה מתאפסת כל יום.',
  ...
  ru: {
    ...
    'admin.orgs.addNewShort': 'Добавить',
    ...
    'admin.orgs.stats': 'Статистика',
    'admin.orgs.info': 'Информация',
    ...
    'settings.booking': 'Онлайн запись',
    'settings.booking.desc': 'Настройка онлайн записи клиентов',
    
    // Booking Settings
    'booking.title': 'Настройки онлайн записи',
    'booking.subtitle': 'Управление онлайн записью клиентов',
    'booking.enabled': 'Включить онлайн запись',
    'booking.enabled.desc': 'Позволить клиентам записываться через публичную ссылку',
    'booking.slug': 'Ссылка для записи',
    'booking.slug.desc': 'Уникальный URL для страницы записи',
    'booking.slug.placeholder': 'my-business',
    'booking.slug.preview': 'Ваша ссылка',
    'booking.slug.copy': 'Копировать',
    'booking.slug.copied': 'Ссылка скопирована!',
    'booking.workingHours': 'Часы работы',
    'booking.workingHours.desc': 'Настройте часы работы по дням недели',
    'booking.day.sunday': 'Воскресенье',
    'booking.day.monday': 'Понедельник',
    'booking.day.tuesday': 'Вторник',
    'booking.day.wednesday': 'Среда',
    'booking.day.thursday': 'Четверг',
    'booking.day.friday': 'Пятница',
    'booking.day.saturday': 'Суббота',
    'booking.day.enabled': 'Работаем',
    'booking.hours.start': 'Начало',
    'booking.hours.end': 'Конец',
    'booking.break': 'Перерыв',
    'booking.break.enabled': 'Есть перерыв',
    'booking.break.start': 'Начало перерыва',
    'booking.break.end': 'Конец перерыва',
    'booking.slotDuration': 'Длительность слота (минуты)',
    'booking.slotDuration.desc': 'Сколько времени на одну запись',
    'booking.minAdvanceHours': 'Минимум часов заранее',
    'booking.minAdvanceHours.desc': 'За сколько часов нужно записываться',
    'booking.maxDaysAhead': 'Максимум дней вперёд',
    'booking.maxDaysAhead.desc': 'На сколько вперёд можно записаться',
    'booking.confirmMessage': 'Сообщение подтверждения',
    'booking.confirmMessage.desc': 'Сообщение клиенту после записи (иврит)',
    'booking.confirmMessage.placeholder': 'תודה על ההזמנה! נחזור אליך בהקדם.',
    'booking.confirmMessageRu': 'Сообщение подтверждения (русский)',
    'booking.confirmMessageRu.desc': 'Сообщение клиенту после записи (русский)',
    'booking.confirmMessageRu.placeholder': 'Спасибо за запись! Мы свяжемся с вами.',
    'booking.save': 'Сохранить настройки',
    'booking.saving': 'Сохранение...',
    'booking.saved': 'Настройки сохранены!',
    
    // Online Bookings (Visits Page Tab)
    'bookings.title': 'Онлайн записи',
    'bookings.pending': 'Ожидают',
    'bookings.confirmed': 'Подтверждены',
    'bookings.cancelled': 'Отменены',
    'bookings.name': 'Имя',
    ...
    'bookings.confirming': 'Подтверждение...',
    'bookings.cancelling': 'Отмена...',
    'bookings.confirmSuccess': 'Запись подтверждена и визит создан!',
    'bookings.cancelSuccess': 'Запись отменена',
    'bookings.noBookings': 'Нет записей',
    'bookings.noPending': 'Нет ожидающих записей',
    ...
    'dashboard.todayBookings': 'Записи на сегодня',
    'dashboard.lowStock': 'Низкий остаток',
    'dashboard.pendingBookings': 'Ожидающие записи',
    'dashboard.avgVisit': 'Средний чек',
    'dashboard.customize': 'Настройка дашборда',
    'dashboard.customize.desc': 'Выберите какие виджеты показывать на дашборде',
    'dashboard.customize.title': 'Настройка дашборда',
    'dashboard.customize.subtitle': 'Выберите до 4 виджетов для мобильного, до 8 для десктопа',
    'dashboard.customize.available': 'Доступные виджеты',
    'dashboard.customize.moveUp': 'Вверх',
    'dashboard.customize.moveDown': 'Вниз',
    'dashboard.customize.maxMobile': 'Максимум 4 виджета на мобильном',
    'dashboard.customize.maxDesktop': 'Максимум 8 виджетов на десктопе',
    'dashboard.widgets.visits_month': 'Визиты за месяц',
    'dashboard.widgets.total_clients': 'Всего клиентов',
    'dashboard.widgets.inactive_clients': 'Неактивные клиенты',
    'dashboard.widgets.revenue_month': 'Доход за месяц',
    'dashboard.widgets.today_bookings': 'Записи на сегодня',
    ...
    'clients.createPaymentLink': 'Создать ссылку на оплату',
    'clients.sendSMS': 'Отправить SMS',
    'clients.visitHistory': 'История визитов',
    'clients.noVisitHistory': 'Нет истории визитов',
    'clients.payments': 'Платежи',
    'clients.noPayments': 'Нет платежей',
    'clients.sms': 'SMS',
    'clients.noSMS': 'Нет SMS-сообщений',
    'clients.adminRole': 'Администратор системы',
    'clients.manager': 'Менеджер',
    'clients.fullAccess': 'Полный доступ',
    'clients.limitedAccess': 'Ограниченный доступ',
    'clients.removePermissions': 'Удалить права',
    'clients.removing': 'Удаление...',
    'clients.assignAsAdmin': 'Назначить администратором',
    'clients.paid': 'Оплачено',
    'clients.pending': 'Ожидание',
    'clients.failed': 'Не удалось',
    'clients.refunded': 'Возвращено',
    'clients.transactionId': 'ID транзакции',
    'clients.created': 'Создано',
    'clients.allVisits': 'Все визиты',
    'clients.dateLabel': 'Дата',
    'clients.completedAt': 'Завершено',
    'clients.duration': 'Длительность',
    'clients.minutes': 'минут',
    ...
    'visits.status.in_progress': 'В процессе',
    'visits.status.completed': 'Завершён',
    'visits.status.cancelled': 'Отменён',
    'visits.scheduled': 'Запланирован',
    'visits.completed': 'Завершён',
    'visits.viewDetails': 'Посмотреть детали',
    ...
    'visits.confirmPayment': 'Подтвердить оплату',
    ...
    'visits.inProgress': 'В процессе',
    'visits.activeVisit': 'Активный визит',
    'visits.addService': 'Добавить услугу',
    'visits.regularService': 'Постоянная услуга',
    'visits.oneTimeService': 'Разовая услуга',
    'visits.customService': 'Ввести новую услугу',
    'visits.addCustomService': 'Добавить разовую услугу',
    'visits.serviceName': 'Название услуги',
    'visits.enterServiceName': 'Введите название',
    'visits.price': 'Цена',
    'visits.duration': 'Длительность',
    'visits.fillAllFields': 'Пожалуйста, заполните все поля',
    ...
    'inventory.scanner.permissionDenied': 'Требуется разрешение на доступ к камере. Пожалуйста, разрешите доступ в настройках браузера.',
    'inventory.scanner.noCameraFound': 'На этом устройстве камера не найдена.',
    'inventory.scanner.cameraInUse': 'Камера используется другим приложением.',
    'inventory.scanner.unsupportedConstraints': 'Камера не поддерживает требуемые настройки.',
    'inventory.scanner.notSupported': 'Браузер не поддерживает доступ к камере. Используйте обновлённый браузер.',
    'inventory.scanner.placeBarcode': 'Поместите штрих-код в рамку камеры',
    ...
    'careInstructions.create': 'Добавить',
    'careInstructions.writeManually': 'Написать вручную',
    'careInstructions.uploadPDF': 'Загрузить PDF',
    'careInstructions.selectPDFFile': 'Выберите PDF файл',
    'careInstructions.pdfUploadNote': 'Файл будет сохранён и автоматически отправлен клиентам',
    ...
    'careInstructions.downloadAsTxt': 'Скачать как текстовый файл',
    ...
    // Broadcast (WhatsApp рассылка)
    'broadcast.title': 'WhatsApp рассылка',
    'broadcast.limitTitle': 'Дневной лимит отправки',
    'broadcast.limitOver': '🚫 Дневной лимит исчерпан',
    'broadcast.limitOverDesc': 'Новые сообщения можно будет отправить завтра. WhatsApp ограничивает массовую рассылку для защиты аккаунта.',
    'broadcast.limitRemaining': 'Осталось {count} сообщений на сегодня',
    'broadcast.searchPlaceholder': 'Поиск клиента...',
    'broadcast.filterAll': 'Все',
    'broadcast.filter30': '30+ дней',
    'broadcast.filter60': '60+ дней',
    'broadcast.filter90': '90+ дней',
    'broadcast.selectedCount': 'Выбрано {count}',
    'broadcast.selectAll': 'Выбрать всех',
    'broadcast.clearSelection': 'Очистить',
    'broadcast.daysAgo': '{count} дн.',
    'broadcast.noClients': 'Клиенты не найдены',
    'broadcast.messageTitle': 'Текст сообщения',
    'broadcast.messagePlaceholder': 'Напишите сообщение здесь...',
    'broadcast.messageNote': '* Сообщение будет отправлено всем выбранным клиентам',
    'broadcast.selectedSummary': 'Выбрано {count} клиентов для отправки',
    'broadcast.resultTitle': 'Рассылка отправлена!',
    'broadcast.resultSent': 'Отправлено: {count}',
    'broadcast.resultFailed': 'Ошибок: {count}',
    'broadcast.resultSkipped': 'Пропущено (лимит): {count}',
    'broadcast.sendBtn': 'Отправить {count} клиентам',
    'broadcast.sending': 'Отправляем...',
    'broadcast.limitNote': 'WhatsApp ограничивает рассылку до 30 сообщений в 24 часа. Лимит сбрасывается каждый день.',
