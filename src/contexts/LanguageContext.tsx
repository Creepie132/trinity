...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'dashboard.widgets.visits_month': 'ביקורים החודש',
    ...
    'clients.visitHistory': 'היסטוריית ביקורים',
    'clients.noVisitHistory': 'אין היסטוריית ביקורים',
