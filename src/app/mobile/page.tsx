...
const CHANGELOG = [
  ...
  },
  {
    ...
    date: '13.04.2026',
    changes: [
      'Квитанция Tranzila: кнопка «Квитанция» в деталях платежа для completed-платежей',
      'Открывает подписанный PDF-документ от Tranzila прямо в браузере',
      'Первое открытие создаёт документ автоматически и сохраняет для повторных просмотров',
    ],
  },
  {
    version: '2.8.0',
  ...
  },
  {
    ...
    date: '12.04.2026',
    changes: [
      'Администратор: пошаговое добавление новой организации прямо из приложения',
      'Шаг 1 — email и название, шаг 2 — выбор модулей, шаг 3 — подтверждение',
      'После создания клиент автоматически получает приглашение на почту',
    ],
  },
  {
    version: '2.7.0',
  ...
  },
  {
    ...
    date: '12.04.2026',
    changes: [
      'Исправлено отображение иврита в WhatsApp-автосообщениях — правильный порядок слов при смешанном тексте',
      'Поле шаблона автосообщений теперь автоматически переключается на RTL для иврита',
    ],
  },
  {
    version: '2.6.0',
