...
import { LayoutDashboard, Megaphone, Settings, ArrowLeft, Home, LogOut, Building2, CreditCard, BarChart3, HeadphonesIcon, FlaskConical, Package, Image } from 'lucide-react'
