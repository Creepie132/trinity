...
const NOTIFICATION_TYPE_TO_SETTING: Record<string, string> = {
  ...
  visit_overdue_2h:       'visit_reminder',
  visit_overdue_3h:       'visit_reminder',
  visit_overdue_4h:       'visit_reminder',
  visit_overdue_5h:       'visit_reminder',
  visit_overdue_6h:       'visit_reminder',
